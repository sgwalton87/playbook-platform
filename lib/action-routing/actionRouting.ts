...
export function getRoleNotifications() {
  return [
    ...
    },
    {
      ...
      message: "Scholar needs support gathering documents for an internship application.",
    ...
    },
    {
      ...
      message: "Scholar requested readiness verification for a health careers opportunity.",
    ...
    },
    {
      ...
      message: "Scholar has an interview-related opportunity and needs practice.",
