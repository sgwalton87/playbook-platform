...
const SCHOLAR_SUPPORT: OnboardingStep = {
  ...
  body: "This private information helps us understand who we serve and pursue funding. You may skip any question you prefer not to answer.",
  fields: [
...
const SCHOLAR_ACADEMIC: OnboardingStep = {
  ...
  fields: [
    ...
    { key: "dream_school", label: "Dream school", type: "college", placeholder: "Start typing a college..." },
    { key: "top_schools", label: "Top 10 schools", type: "college-list", placeholder: "Start typing a college..." },
  ],
};
