...
export const Artifacts = {
  ...
  executionCampaign: "pbos/runtime/execution-campaign.json",
  campaignApproval: "pbos/runtime/campaign-approval.json",
  campaignProgress: "pbos/runtime/campaign-progress.json",
