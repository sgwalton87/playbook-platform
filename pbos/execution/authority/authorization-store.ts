...
export interface ExecutionAuthorizationHistory {
  ...
  readonly history: readonly ExecutionAuthorization[];
...
export function loadProviderExecutionAuthorization(
  ...
  if (
    ...
    !isAuthorization(value.latest) ||
    !Array.isArray(value.history) ||
    !value.history.every(isAuthorization) ||
...
export function persistProviderExecutionAuthorization(
  ...
  const existing = loadProviderExecutionAuthorization(rootDir);
