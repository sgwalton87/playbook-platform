...
PPS-3230 is the canonical constitutional authority for the Opportunity Center. It defines the application boundary, ownership, contracts, controls, evidence, and PBOS conditions required before implementation or material change.

# Mission

The application shall provide the canonical shared discovery, matching, readiness, saving, and action surface for governed opportunities.

# Vision

Opportunity Center shall remain a durable shared platform product that can serve multiple Operating Systems without forks, shadow records, or role-specific duplication.

# Strategic Importance

Opportunity Center establishes one governed opportunity center capability across Playbook. Centralizing this responsibility protects interoperability, user trust, and long-term constitutional consistency.
...
In scope: provide the canonical shared discovery, matching, readiness, saving, and action surface for governed opportunities; the full lifecycle of opportunity listings, sources, eligibility rules, Scholar projections, preferences and actions; and the governed production of matches, explanations, saved state, readiness gaps, application handoffs.
...
Opportunity Center owns its application workflow state, public contracts, user-facing outcomes, lifecycle evidence, and coordination of registered dependencies.

# Business Responsibilities

Define valid outcomes, accountable actors, business rules, exception handling, completion evidence, retention obligations, and measurable value for opportunity center workflows.
...
- Opportunity Center query and command boundary
- Opportunity Center lifecycle and policy evaluation
- Opportunity Center evidence, audit, and projection service

# Application Modules

- Opportunity Center workspace
- Opportunity Center workflow coordinator
- Opportunity Center administration and evidence inspector
...
Opportunity and Compass intelligence may rank and explain candidates without restricting independent search or application.
...
opportunity listings, sources, eligibility rules, Scholar projections, preferences and actions.

# Generated Data

matches, explanations, saved state, readiness gaps, application handoffs.
...
Canonical domain records remain owned by their upstream authorities. Opportunity Center owns only application-specific workflow state and approved artifacts; it submits validated commands rather than mutating upstream truth.
...
- stale listings: fail closed, preserve evidence, and route to the declared recovery owner
- false eligibility: fail closed, preserve evidence, and route to the declared recovery owner
- discriminatory ranking: fail closed, preserve evidence, and route to the declared recovery owner
- deadline error: fail closed, preserve evidence, and route to the declared recovery owner
...
Only authorized actors may initiate or decide opportunity center outcomes; required evidence shall precede completion; derived signals are not canonical facts; notifications do not confirm transactions; ambiguous state blocks progression.
...
Emit registered domain events and allow PPS-3211 to resolve authorized recipients and preferences. Delivery failure never changes opportunity center truth.
...
- stale listings: requires explicit prevention, detection, recovery, owner, and release evidence
- false eligibility: requires explicit prevention, detection, recovery, owner, and release evidence
- discriminatory ranking: requires explicit prevention, detection, recovery, owner, and release evidence
- deadline error: requires explicit prevention, detection, recovery, owner, and release evidence
...
Volume 30 registers the product artifacts used to realize this document. Opportunity Center references those identifiers and shall not create parallel feature, workflow, API, data, event, notification, or integration registries.
...
Future capability, service, infrastructure, Universe, screen, and implementation volumes may refine downstream contracts but shall not silently supersede PPS-3230 or PPS-3200.

# PBOS Build Inputs

Canonical PPS-3230 at version 1.0.0, resolved upstream documents, registered product artifacts, repository context, gate, contract, work package, authorization, and release policy.
...
Planning key PPS-3230; lifecycle canonical; parent PPS-3200; priority derives from constitutional dependency order; selectors shall not invent gates, capabilities, services, or dependencies.

# PBOS Execution Metadata

Execution binds repository root, remote, branch, commit, content identity, gate, contract, work package, authorization identity, application PPS-3230, specification version, adapter, and evidence destination.
