...
PPS-3291 is the canonical constitutional authority for the Compass Application. It defines the application boundary, ownership, contracts, controls, evidence, and PBOS conditions required before implementation or material change.

# Mission

The application shall turn authorized Scholar Record and journey signals into explainable goals, alternatives, and next-action proposals.

# Vision

Compass Application shall remain a durable shared platform product that can serve multiple Operating Systems without forks, shadow records, or role-specific duplication.

# Strategic Importance

Compass Application establishes one governed compass capability across Playbook. Centralizing this responsibility protects interoperability, user trust, and long-term constitutional consistency.
...
In scope: turn authorized Scholar Record and journey signals into explainable goals, alternatives, and next-action proposals; the full lifecycle of authorized Record projections, goals, evidence, opportunities, learning and relationship context; and the governed production of recommendations, reasons, alternatives, confidence and accepted actions.
...
Compass Application owns its application workflow state, public contracts, user-facing outcomes, lifecycle evidence, and coordination of registered dependencies.

# Business Responsibilities

Define valid outcomes, accountable actors, business rules, exception handling, completion evidence, retention obligations, and measurable value for compass workflows.
...
- Compass query and command boundary
- Compass lifecycle and policy evaluation
- Compass evidence, audit, and projection service

# Application Modules

- Compass workspace
- Compass workflow coordinator
- Compass administration and evidence inspector
...
Compass is advisory, evidence-based, explainable, reversible, and subject to user choice.
...
authorized Record projections, goals, evidence, opportunities, learning and relationship context.

# Generated Data

recommendations, reasons, alternatives, confidence and accepted actions.
...
Canonical domain records remain owned by their upstream authorities. Compass Application owns only application-specific workflow state and approved artifacts; it submits validated commands rather than mutating upstream truth.
...
- overconfident guidance: fail closed, preserve evidence, and route to the declared recovery owner
- hidden factors: fail closed, preserve evidence, and route to the declared recovery owner
- stale context: fail closed, preserve evidence, and route to the declared recovery owner
- reduced agency: fail closed, preserve evidence, and route to the declared recovery owner
...
Only authorized actors may initiate or decide compass outcomes; required evidence shall precede completion; derived signals are not canonical facts; notifications do not confirm transactions; ambiguous state blocks progression.
...
Emit registered domain events and allow PPS-3211 to resolve authorized recipients and preferences. Delivery failure never changes compass truth.
...
- overconfident guidance: requires explicit prevention, detection, recovery, owner, and release evidence
- hidden factors: requires explicit prevention, detection, recovery, owner, and release evidence
- stale context: requires explicit prevention, detection, recovery, owner, and release evidence
- reduced agency: requires explicit prevention, detection, recovery, owner, and release evidence
...
Volume 30 registers the product artifacts used to realize this document. Compass Application references those identifiers and shall not create parallel feature, workflow, API, data, event, notification, or integration registries.
...
Future capability, service, infrastructure, Universe, screen, and implementation volumes may refine downstream contracts but shall not silently supersede PPS-3291 or PPS-3200.

# PBOS Build Inputs

Canonical PPS-3291 at version 1.0.0, resolved upstream documents, registered product artifacts, repository context, gate, contract, work package, authorization, and release policy.
...
Planning key PPS-3291; lifecycle canonical; parent PPS-3200; priority derives from constitutional dependency order; selectors shall not invent gates, capabilities, services, or dependencies.

# PBOS Execution Metadata

Execution binds repository root, remote, branch, commit, content identity, gate, contract, work package, authorization identity, application PPS-3291, specification version, adapter, and evidence destination.
