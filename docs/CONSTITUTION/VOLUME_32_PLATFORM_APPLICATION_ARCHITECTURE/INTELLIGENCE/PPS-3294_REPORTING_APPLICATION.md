...
PPS-3294 is the canonical constitutional authority for the Reporting Application. It defines the application boundary, ownership, contracts, controls, evidence, and PBOS conditions required before implementation or material change.

# Mission

The application shall generate, distribute, retain, and reproduce governed reports with explicit source, audience, freshness, and limitations.

# Vision

Reporting Application shall remain a durable shared platform product that can serve multiple Operating Systems without forks, shadow records, or role-specific duplication.

# Strategic Importance

Reporting Application establishes one governed reporting capability across Playbook. Centralizing this responsibility protects interoperability, user trust, and long-term constitutional consistency.
...
In scope: generate, distribute, retain, and reproduce governed reports with explicit source, audience, freshness, and limitations; the full lifecycle of approved metrics, queries, templates, audience, schedule, retention and source versions; and the governed production of report snapshots, distributions, acknowledgements and audit evidence.
...
Reporting Application owns its application workflow state, public contracts, user-facing outcomes, lifecycle evidence, and coordination of registered dependencies.

# Business Responsibilities

Define valid outcomes, accountable actors, business rules, exception handling, completion evidence, retention obligations, and measurable value for reporting workflows.
...
- Reporting query and command boundary
- Reporting lifecycle and policy evaluation
- Reporting evidence, audit, and projection service

# Application Modules

- Reporting workspace
- Reporting workflow coordinator
- Reporting administration and evidence inspector
...
assistance may summarize verified report content; it shall not fabricate metrics, conclusions, recipients, or certification.
...
approved metrics, queries, templates, audience, schedule, retention and source versions.

# Generated Data

report snapshots, distributions, acknowledgements and audit evidence.
...
Canonical domain records remain owned by their upstream authorities. Reporting Application owns only application-specific workflow state and approved artifacts; it submits validated commands rather than mutating upstream truth.
...
- wrong audience: fail closed, preserve evidence, and route to the declared recovery owner
- stale report: fail closed, preserve evidence, and route to the declared recovery owner
- irreproducible result: fail closed, preserve evidence, and route to the declared recovery owner
- misleading narrative: fail closed, preserve evidence, and route to the declared recovery owner
...
Only authorized actors may initiate or decide reporting outcomes; required evidence shall precede completion; derived signals are not canonical facts; notifications do not confirm transactions; ambiguous state blocks progression.
...
Emit registered domain events and allow PPS-3211 to resolve authorized recipients and preferences. Delivery failure never changes reporting truth.
...
- wrong audience: requires explicit prevention, detection, recovery, owner, and release evidence
- stale report: requires explicit prevention, detection, recovery, owner, and release evidence
- irreproducible result: requires explicit prevention, detection, recovery, owner, and release evidence
- misleading narrative: requires explicit prevention, detection, recovery, owner, and release evidence
...
Volume 30 registers the product artifacts used to realize this document. Reporting Application references those identifiers and shall not create parallel feature, workflow, API, data, event, notification, or integration registries.
...
Future capability, service, infrastructure, Universe, screen, and implementation volumes may refine downstream contracts but shall not silently supersede PPS-3294 or PPS-3200.

# PBOS Build Inputs

Canonical PPS-3294 at version 1.0.0, resolved upstream documents, registered product artifacts, repository context, gate, contract, work package, authorization, and release policy.
...
Planning key PPS-3294; lifecycle canonical; parent PPS-3200; priority derives from constitutional dependency order; selectors shall not invent gates, capabilities, services, or dependencies.

# PBOS Execution Metadata

Execution binds repository root, remote, branch, commit, content identity, gate, contract, work package, authorization identity, application PPS-3294, specification version, adapter, and evidence destination.
