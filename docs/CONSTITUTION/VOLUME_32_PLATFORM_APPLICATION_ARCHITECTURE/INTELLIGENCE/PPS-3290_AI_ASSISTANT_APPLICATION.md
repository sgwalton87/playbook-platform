...
PPS-3290 is the canonical constitutional authority for the AI Assistant Application. It defines the application boundary, ownership, contracts, controls, evidence, and PBOS conditions required before implementation or material change.

# Mission

The application shall provide explainable, permission-aware assistance that preserves human control and constitutional application boundaries.

# Vision

AI Assistant Application shall remain a durable shared platform product that can serve multiple Operating Systems without forks, shadow records, or role-specific duplication.

# Strategic Importance

AI Assistant Application establishes one governed ai assistant capability across Playbook. Centralizing this responsibility protects interoperability, user trust, and long-term constitutional consistency.
...
In scope: provide explainable, permission-aware assistance that preserves human control and constitutional application boundaries; the full lifecycle of authorized context, user request, source references, policy, model and tool state; and the governed production of responses, citations, proposed actions, safety decisions and audit evidence.
...
AI Assistant Application owns its application workflow state, public contracts, user-facing outcomes, lifecycle evidence, and coordination of registered dependencies.

# Business Responsibilities

Define valid outcomes, accountable actors, business rules, exception handling, completion evidence, retention obligations, and measurable value for ai assistant workflows.
...
- AI Assistant query and command boundary
- AI Assistant lifecycle and policy evaluation
- AI Assistant evidence, audit, and projection service

# Application Modules

- AI Assistant workspace
- AI Assistant workflow coordinator
- AI Assistant administration and evidence inspector
...
the application orchestrates approved intelligence and tools; consequential actions require explicit governed authorization.
...
authorized context, user request, source references, policy, model and tool state.

# Generated Data

responses, citations, proposed actions, safety decisions and audit evidence.
...
Canonical domain records remain owned by their upstream authorities. AI Assistant Application owns only application-specific workflow state and approved artifacts; it submits validated commands rather than mutating upstream truth.
...
- hallucination: fail closed, preserve evidence, and route to the declared recovery owner
- prompt injection: fail closed, preserve evidence, and route to the declared recovery owner
- tool overreach: fail closed, preserve evidence, and route to the declared recovery owner
- sensitive-data disclosure: fail closed, preserve evidence, and route to the declared recovery owner
...
Only authorized actors may initiate or decide ai assistant outcomes; required evidence shall precede completion; derived signals are not canonical facts; notifications do not confirm transactions; ambiguous state blocks progression.
...
Emit registered domain events and allow PPS-3211 to resolve authorized recipients and preferences. Delivery failure never changes ai assistant truth.
...
- hallucination: requires explicit prevention, detection, recovery, owner, and release evidence
- prompt injection: requires explicit prevention, detection, recovery, owner, and release evidence
- tool overreach: requires explicit prevention, detection, recovery, owner, and release evidence
- sensitive-data disclosure: requires explicit prevention, detection, recovery, owner, and release evidence
...
Volume 30 registers the product artifacts used to realize this document. AI Assistant Application references those identifiers and shall not create parallel feature, workflow, API, data, event, notification, or integration registries.
...
Future capability, service, infrastructure, Universe, screen, and implementation volumes may refine downstream contracts but shall not silently supersede PPS-3290 or PPS-3200.

# PBOS Build Inputs

Canonical PPS-3290 at version 1.0.0, resolved upstream documents, registered product artifacts, repository context, gate, contract, work package, authorization, and release policy.
...
Planning key PPS-3290; lifecycle canonical; parent PPS-3200; priority derives from constitutional dependency order; selectors shall not invent gates, capabilities, services, or dependencies.

# PBOS Execution Metadata

Execution binds repository root, remote, branch, commit, content identity, gate, contract, work package, authorization identity, application PPS-3290, specification version, adapter, and evidence destination.
