...
PPS-3274 is the canonical constitutional authority for the Tax Application. It defines the application boundary, ownership, contracts, controls, evidence, and PBOS conditions required before implementation or material change.

# Mission

The application shall provide tax literacy, record-readiness education, deadline awareness, and referral boundaries without filing or professional representation.

# Vision

Tax Application shall remain a durable shared platform product that can serve multiple Operating Systems without forks, shadow records, or role-specific duplication.

# Strategic Importance

Tax Application establishes one governed tax capability across Playbook. Centralizing this responsibility protects interoperability, user trust, and long-term constitutional consistency.
...
In scope: provide tax literacy, record-readiness education, deadline awareness, and referral boundaries without filing or professional representation; the full lifecycle of learning context, jurisdiction, tax-year sources, user-entered educational scenarios; and the governed production of checklists, educational calculations, competency progress and referrals.
...
Tax Application owns its application workflow state, public contracts, user-facing outcomes, lifecycle evidence, and coordination of registered dependencies.

# Business Responsibilities

Define valid outcomes, accountable actors, business rules, exception handling, completion evidence, retention obligations, and measurable value for tax workflows.
...
- Tax query and command boundary
- Tax lifecycle and policy evaluation
- Tax evidence, audit, and projection service

# Application Modules

- Tax workspace
- Tax workflow coordinator
- Tax administration and evidence inspector
...
assistance may explain dated source material; filing, definitive advice, and unsupervised sensitive-document extraction are prohibited.
...
learning context, jurisdiction, tax-year sources, user-entered educational scenarios.

# Generated Data

checklists, educational calculations, competency progress and referrals.
...
Canonical domain records remain owned by their upstream authorities. Tax Application owns only application-specific workflow state and approved artifacts; it submits validated commands rather than mutating upstream truth.
...
- jurisdiction error: fail closed, preserve evidence, and route to the declared recovery owner
- stale law: fail closed, preserve evidence, and route to the declared recovery owner
- sensitive data leakage: fail closed, preserve evidence, and route to the declared recovery owner
...
Only authorized actors may initiate or decide tax outcomes; required evidence shall precede completion; derived signals are not canonical facts; notifications do not confirm transactions; ambiguous state blocks progression.
...
Emit registered domain events and allow PPS-3211 to resolve authorized recipients and preferences. Delivery failure never changes tax truth.
...
- jurisdiction error: requires explicit prevention, detection, recovery, owner, and release evidence
- stale law: requires explicit prevention, detection, recovery, owner, and release evidence
- sensitive data leakage: requires explicit prevention, detection, recovery, owner, and release evidence
...
Volume 30 registers the product artifacts used to realize this document. Tax Application references those identifiers and shall not create parallel feature, workflow, API, data, event, notification, or integration registries.
...
Future capability, service, infrastructure, Universe, screen, and implementation volumes may refine downstream contracts but shall not silently supersede PPS-3274 or PPS-3200.

# PBOS Build Inputs

Canonical PPS-3274 at version 1.0.0, resolved upstream documents, registered product artifacts, repository context, gate, contract, work package, authorization, and release policy.
...
Planning key PPS-3274; lifecycle canonical; parent PPS-3200; priority derives from constitutional dependency order; selectors shall not invent gates, capabilities, services, or dependencies.

# PBOS Execution Metadata

Execution binds repository root, remote, branch, commit, content identity, gate, contract, work package, authorization identity, application PPS-3274, specification version, adapter, and evidence destination.
