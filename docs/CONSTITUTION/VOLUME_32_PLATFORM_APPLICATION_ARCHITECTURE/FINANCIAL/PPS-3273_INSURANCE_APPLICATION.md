...
PPS-3273 is the canonical constitutional authority for the Insurance Application. It defines the application boundary, ownership, contracts, controls, evidence, and PBOS conditions required before implementation or material change.

# Mission

The application shall provide coverage, risk, terminology, and claims-process literacy through governed educational scenarios.

# Vision

Insurance Application shall remain a durable shared platform product that can serve multiple Operating Systems without forks, shadow records, or role-specific duplication.

# Strategic Importance

Insurance Application establishes one governed insurance capability across Playbook. Centralizing this responsibility protects interoperability, user trust, and long-term constitutional consistency.
...
In scope: provide coverage, risk, terminology, and claims-process literacy through governed educational scenarios; the full lifecycle of learning context, coverage examples, jurisdiction and source dates, scenario choices; and the governed production of educational comparisons, competency progress and source-backed explanations.
...
Insurance Application owns its application workflow state, public contracts, user-facing outcomes, lifecycle evidence, and coordination of registered dependencies.

# Business Responsibilities

Define valid outcomes, accountable actors, business rules, exception handling, completion evidence, retention obligations, and measurable value for insurance workflows.
...
- Insurance query and command boundary
- Insurance lifecycle and policy evaluation
- Insurance evidence, audit, and projection service

# Application Modules

- Insurance workspace
- Insurance workflow coordinator
- Insurance administration and evidence inspector
...
assistance may explain terms and questions for qualified professionals; it shall not bind or recommend policies.
...
learning context, coverage examples, jurisdiction and source dates, scenario choices.

# Generated Data

educational comparisons, competency progress and source-backed explanations.
...
Canonical domain records remain owned by their upstream authorities. Insurance Application owns only application-specific workflow state and approved artifacts; it submits validated commands rather than mutating upstream truth.
...
- coverage misinformation: fail closed, preserve evidence, and route to the declared recovery owner
- jurisdiction drift: fail closed, preserve evidence, and route to the declared recovery owner
- sensitive disclosure: fail closed, preserve evidence, and route to the declared recovery owner
- sales influence: fail closed, preserve evidence, and route to the declared recovery owner
...
Only authorized actors may initiate or decide insurance outcomes; required evidence shall precede completion; derived signals are not canonical facts; notifications do not confirm transactions; ambiguous state blocks progression.
...
Emit registered domain events and allow PPS-3211 to resolve authorized recipients and preferences. Delivery failure never changes insurance truth.
...
- coverage misinformation: requires explicit prevention, detection, recovery, owner, and release evidence
- jurisdiction drift: requires explicit prevention, detection, recovery, owner, and release evidence
- sensitive disclosure: requires explicit prevention, detection, recovery, owner, and release evidence
- sales influence: requires explicit prevention, detection, recovery, owner, and release evidence
...
Volume 30 registers the product artifacts used to realize this document. Insurance Application references those identifiers and shall not create parallel feature, workflow, API, data, event, notification, or integration registries.
...
Future capability, service, infrastructure, Universe, screen, and implementation volumes may refine downstream contracts but shall not silently supersede PPS-3273 or PPS-3200.

# PBOS Build Inputs

Canonical PPS-3273 at version 1.0.0, resolved upstream documents, registered product artifacts, repository context, gate, contract, work package, authorization, and release policy.
...
Planning key PPS-3273; lifecycle canonical; parent PPS-3200; priority derives from constitutional dependency order; selectors shall not invent gates, capabilities, services, or dependencies.

# PBOS Execution Metadata

Execution binds repository root, remote, branch, commit, content identity, gate, contract, work package, authorization identity, application PPS-3273, specification version, adapter, and evidence destination.
