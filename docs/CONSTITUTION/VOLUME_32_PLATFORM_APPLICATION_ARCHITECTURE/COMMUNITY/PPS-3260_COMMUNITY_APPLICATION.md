...
PPS-3260 is the canonical constitutional authority for the Community Application. It defines the application boundary, ownership, contracts, controls, evidence, and PBOS conditions required before implementation or material change.

# Mission

The application shall provide the governed community entry point for safe discovery, participation, contribution, and moderation.

# Vision

Community Application shall remain a durable shared platform product that can serve multiple Operating Systems without forks, shadow records, or role-specific duplication.

# Strategic Importance

Community Application establishes one governed community capability across Playbook. Centralizing this responsibility protects interoperability, user trust, and long-term constitutional consistency.
...
In scope: provide the governed community entry point for safe discovery, participation, contribution, and moderation; the full lifecycle of community identity, membership, content references, relationships, participation and safety state; and the governed production of community views, participation events, moderation handoffs and reputation signals.
...
Community Application owns its application workflow state, public contracts, user-facing outcomes, lifecycle evidence, and coordination of registered dependencies.

# Business Responsibilities

Define valid outcomes, accountable actors, business rules, exception handling, completion evidence, retention obligations, and measurable value for community workflows.
...
- Community query and command boundary
- Community lifecycle and policy evaluation
- Community evidence, audit, and projection service

# Application Modules

- Community workspace
- Community workflow coordinator
- Community administration and evidence inspector
...
assistance may support discovery and safety triage without replacing moderation or creating relationships.
...
community identity, membership, content references, relationships, participation and safety state.

# Generated Data

community views, participation events, moderation handoffs and reputation signals.
...
Canonical domain records remain owned by their upstream authorities. Community Application owns only application-specific workflow state and approved artifacts; it submits validated commands rather than mutating upstream truth.
...
- harassment: fail closed, preserve evidence, and route to the declared recovery owner
- unsafe discovery: fail closed, preserve evidence, and route to the declared recovery owner
- moderation inconsistency: fail closed, preserve evidence, and route to the declared recovery owner
- echo chambers: fail closed, preserve evidence, and route to the declared recovery owner
...
Only authorized actors may initiate or decide community outcomes; required evidence shall precede completion; derived signals are not canonical facts; notifications do not confirm transactions; ambiguous state blocks progression.
...
Emit registered domain events and allow PPS-3211 to resolve authorized recipients and preferences. Delivery failure never changes community truth.
...
- harassment: requires explicit prevention, detection, recovery, owner, and release evidence
- unsafe discovery: requires explicit prevention, detection, recovery, owner, and release evidence
- moderation inconsistency: requires explicit prevention, detection, recovery, owner, and release evidence
- echo chambers: requires explicit prevention, detection, recovery, owner, and release evidence
...
Volume 30 registers the product artifacts used to realize this document. Community Application references those identifiers and shall not create parallel feature, workflow, API, data, event, notification, or integration registries.
...
Future capability, service, infrastructure, Universe, screen, and implementation volumes may refine downstream contracts but shall not silently supersede PPS-3260 or PPS-3200.

# PBOS Build Inputs

Canonical PPS-3260 at version 1.0.0, resolved upstream documents, registered product artifacts, repository context, gate, contract, work package, authorization, and release policy.
...
Planning key PPS-3260; lifecycle canonical; parent PPS-3200; priority derives from constitutional dependency order; selectors shall not invent gates, capabilities, services, or dependencies.

# PBOS Execution Metadata

Execution binds repository root, remote, branch, commit, content identity, gate, contract, work package, authorization identity, application PPS-3260, specification version, adapter, and evidence destination.
