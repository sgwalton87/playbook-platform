...
PPS-3262 is the canonical constitutional authority for the Groups Application. It defines the application boundary, ownership, contracts, controls, evidence, and PBOS conditions required before implementation or material change.

# Mission

The application shall govern purpose-bound group discovery, membership, roles, collaboration, content, and moderation.

# Vision

Groups Application shall remain a durable shared platform product that can serve multiple Operating Systems without forks, shadow records, or role-specific duplication.

# Strategic Importance

Groups Application establishes one governed groups capability across Playbook. Centralizing this responsibility protects interoperability, user trust, and long-term constitutional consistency.
...
In scope: govern purpose-bound group discovery, membership, roles, collaboration, content, and moderation; the full lifecycle of group identity, purpose, membership, roles, content references and moderation state; and the governed production of membership lifecycle, group activity, role assignments and safety evidence.
...
Groups Application owns its application workflow state, public contracts, user-facing outcomes, lifecycle evidence, and coordination of registered dependencies.

# Business Responsibilities

Define valid outcomes, accountable actors, business rules, exception handling, completion evidence, retention obligations, and measurable value for groups workflows.
...
- Groups query and command boundary
- Groups lifecycle and policy evaluation
- Groups evidence, audit, and projection service

# Application Modules

- Groups workspace
- Groups workflow coordinator
- Groups administration and evidence inspector
...
assistance may suggest relevant groups with reasons; membership and moderation remain human-governed.
...
group identity, purpose, membership, roles, content references and moderation state.

# Generated Data

membership lifecycle, group activity, role assignments and safety evidence.
...
Canonical domain records remain owned by their upstream authorities. Groups Application owns only application-specific workflow state and approved artifacts; it submits validated commands rather than mutating upstream truth.
...
- unauthorized membership: fail closed, preserve evidence, and route to the declared recovery owner
- unsafe groups: fail closed, preserve evidence, and route to the declared recovery owner
- role escalation: fail closed, preserve evidence, and route to the declared recovery owner
- content leakage: fail closed, preserve evidence, and route to the declared recovery owner
...
Only authorized actors may initiate or decide groups outcomes; required evidence shall precede completion; derived signals are not canonical facts; notifications do not confirm transactions; ambiguous state blocks progression.
...
Emit registered domain events and allow PPS-3211 to resolve authorized recipients and preferences. Delivery failure never changes groups truth.
...
- unauthorized membership: requires explicit prevention, detection, recovery, owner, and release evidence
- unsafe groups: requires explicit prevention, detection, recovery, owner, and release evidence
- role escalation: requires explicit prevention, detection, recovery, owner, and release evidence
- content leakage: requires explicit prevention, detection, recovery, owner, and release evidence
...
Volume 30 registers the product artifacts used to realize this document. Groups Application references those identifiers and shall not create parallel feature, workflow, API, data, event, notification, or integration registries.
...
Future capability, service, infrastructure, Universe, screen, and implementation volumes may refine downstream contracts but shall not silently supersede PPS-3262 or PPS-3200.

# PBOS Build Inputs

Canonical PPS-3262 at version 1.0.0, resolved upstream documents, registered product artifacts, repository context, gate, contract, work package, authorization, and release policy.
...
Planning key PPS-3262; lifecycle canonical; parent PPS-3200; priority derives from constitutional dependency order; selectors shall not invent gates, capabilities, services, or dependencies.

# PBOS Execution Metadata

Execution binds repository root, remote, branch, commit, content identity, gate, contract, work package, authorization identity, application PPS-3262, specification version, adapter, and evidence destination.
