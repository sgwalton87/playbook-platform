...
PPS-3222 is the canonical constitutional authority for the Assignments Application. It defines the application boundary, ownership, contracts, controls, evidence, and PBOS conditions required before implementation or material change.

# Mission

The application shall govern assignment publication, submission, review, feedback, revision, and evidence lifecycle.

# Vision

Assignments Application shall remain a durable shared platform product that can serve multiple Operating Systems without forks, shadow records, or role-specific duplication.

# Strategic Importance

Assignments Application establishes one governed assignments capability across Playbook. Centralizing this responsibility protects interoperability, user trust, and long-term constitutional consistency.
...
In scope: govern assignment publication, submission, review, feedback, revision, and evidence lifecycle; the full lifecycle of assignment rules, submissions, attachments, rubrics, feedback, grading decisions; and the governed production of submission versions, review state, feedback events, evidence candidates.
...
Assignments Application owns its application workflow state, public contracts, user-facing outcomes, lifecycle evidence, and coordination of registered dependencies.

# Business Responsibilities

Define valid outcomes, accountable actors, business rules, exception handling, completion evidence, retention obligations, and measurable value for assignments workflows.
...
- Assignments query and command boundary
- Assignments lifecycle and policy evaluation
- Assignments evidence, audit, and projection service

# Application Modules

- Assignments workspace
- Assignments workflow coordinator
- Assignments administration and evidence inspector
...
assistance may support drafting and rubric feedback with disclosure; final assessment follows approved human and policy authority.
...
assignment rules, submissions, attachments, rubrics, feedback, grading decisions.

# Generated Data

submission versions, review state, feedback events, evidence candidates.
...
Canonical domain records remain owned by their upstream authorities. Assignments Application owns only application-specific workflow state and approved artifacts; it submits validated commands rather than mutating upstream truth.
...
- lost submissions: fail closed, preserve evidence, and route to the declared recovery owner
- biased grading: fail closed, preserve evidence, and route to the declared recovery owner
- plagiarism misclassification: fail closed, preserve evidence, and route to the declared recovery owner
- unauthorized feedback: fail closed, preserve evidence, and route to the declared recovery owner
...
Only authorized actors may initiate or decide assignments outcomes; required evidence shall precede completion; derived signals are not canonical facts; notifications do not confirm transactions; ambiguous state blocks progression.
...
Emit registered domain events and allow PPS-3211 to resolve authorized recipients and preferences. Delivery failure never changes assignments truth.
...
- lost submissions: requires explicit prevention, detection, recovery, owner, and release evidence
- biased grading: requires explicit prevention, detection, recovery, owner, and release evidence
- plagiarism misclassification: requires explicit prevention, detection, recovery, owner, and release evidence
- unauthorized feedback: requires explicit prevention, detection, recovery, owner, and release evidence
...
Volume 30 registers the product artifacts used to realize this document. Assignments Application references those identifiers and shall not create parallel feature, workflow, API, data, event, notification, or integration registries.
...
Future capability, service, infrastructure, Universe, screen, and implementation volumes may refine downstream contracts but shall not silently supersede PPS-3222 or PPS-3200.

# PBOS Build Inputs

Canonical PPS-3222 at version 1.0.0, resolved upstream documents, registered product artifacts, repository context, gate, contract, work package, authorization, and release policy.
...
Planning key PPS-3222; lifecycle canonical; parent PPS-3200; priority derives from constitutional dependency order; selectors shall not invent gates, capabilities, services, or dependencies.

# PBOS Execution Metadata

Execution binds repository root, remote, branch, commit, content identity, gate, contract, work package, authorization identity, application PPS-3222, specification version, adapter, and evidence destination.
