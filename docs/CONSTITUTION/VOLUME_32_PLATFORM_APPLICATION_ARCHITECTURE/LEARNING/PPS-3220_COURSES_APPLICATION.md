...
PPS-3220 is the canonical constitutional authority for the Courses Application. It defines the application boundary, ownership, contracts, controls, evidence, and PBOS conditions required before implementation or material change.

# Mission

The application shall govern discovery, enrollment, delivery, progress, and completion of approved learning programs.

# Vision

Courses Application shall remain a durable shared platform product that can serve multiple Operating Systems without forks, shadow records, or role-specific duplication.

# Strategic Importance

Courses Application establishes one governed courses capability across Playbook. Centralizing this responsibility protects interoperability, user trust, and long-term constitutional consistency.
...
In scope: govern discovery, enrollment, delivery, progress, and completion of approved learning programs; the full lifecycle of course catalog, enrollment, curriculum versions, progress, assessments, completion rules; and the governed production of enrollment state, progress, completion events, evidence candidates.
...
Courses Application owns its application workflow state, public contracts, user-facing outcomes, lifecycle evidence, and coordination of registered dependencies.

# Business Responsibilities

Define valid outcomes, accountable actors, business rules, exception handling, completion evidence, retention obligations, and measurable value for courses workflows.
...
- Courses query and command boundary
- Courses lifecycle and policy evaluation
- Courses evidence, audit, and projection service

# Application Modules

- Courses workspace
- Courses workflow coordinator
- Courses administration and evidence inspector
...
learning guidance may recommend courses with reasons; it shall not fabricate mastery or completion.
...
course catalog, enrollment, curriculum versions, progress, assessments, completion rules.

# Generated Data

enrollment state, progress, completion events, evidence candidates.
...
Canonical domain records remain owned by their upstream authorities. Courses Application owns only application-specific workflow state and approved artifacts; it submits validated commands rather than mutating upstream truth.
...
- invalid completion: fail closed, preserve evidence, and route to the declared recovery owner
- inaccessible content: fail closed, preserve evidence, and route to the declared recovery owner
- curriculum drift: fail closed, preserve evidence, and route to the declared recovery owner
- lost progress: fail closed, preserve evidence, and route to the declared recovery owner
...
Only authorized actors may initiate or decide courses outcomes; required evidence shall precede completion; derived signals are not canonical facts; notifications do not confirm transactions; ambiguous state blocks progression.
...
Emit registered domain events and allow PPS-3211 to resolve authorized recipients and preferences. Delivery failure never changes courses truth.
...
- invalid completion: requires explicit prevention, detection, recovery, owner, and release evidence
- inaccessible content: requires explicit prevention, detection, recovery, owner, and release evidence
- curriculum drift: requires explicit prevention, detection, recovery, owner, and release evidence
- lost progress: requires explicit prevention, detection, recovery, owner, and release evidence
...
Volume 30 registers the product artifacts used to realize this document. Courses Application references those identifiers and shall not create parallel feature, workflow, API, data, event, notification, or integration registries.
...
Future capability, service, infrastructure, Universe, screen, and implementation volumes may refine downstream contracts but shall not silently supersede PPS-3220 or PPS-3200.

# PBOS Build Inputs

Canonical PPS-3220 at version 1.0.0, resolved upstream documents, registered product artifacts, repository context, gate, contract, work package, authorization, and release policy.
...
Planning key PPS-3220; lifecycle canonical; parent PPS-3200; priority derives from constitutional dependency order; selectors shall not invent gates, capabilities, services, or dependencies.

# PBOS Execution Metadata

Execution binds repository root, remote, branch, commit, content identity, gate, contract, work package, authorization identity, application PPS-3220, specification version, adapter, and evidence destination.
