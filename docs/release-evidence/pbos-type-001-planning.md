...
```json
{
  ...
  "selectedGate": "PBOS-TYPE-001",
  "completedTasks": [
    "Selected PBOS-TYPE-001 as the next eligible production-safe sprint.",
  ...
  "duration": 279,
  "timestamp": "2026-08-10T08:50:37.831Z",
  "release": {
    "currentState": "PROMOTION_COMPLETE",
    "previousState": "PROMOTION_PENDING",
    "transitionTimestamp": "2026-08-10T08:50:37.826Z",
...
## Recommendation
PBOS-TYPE-001 has no configured next gate.
