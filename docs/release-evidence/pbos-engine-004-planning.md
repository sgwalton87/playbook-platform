...
```json
{
  ...
  "selectedGate": "PBOS-ENGINE-004",
  "completedTasks": [
    "Selected PBOS-ENGINE-004 as the next eligible production-safe sprint.",
  ...
  "duration": 463,
  "timestamp": "2026-07-27T15:12:57.718Z",
  "release": {
...
## Recommendation
PBOS-ENGINE-004 has no configured next gate.
