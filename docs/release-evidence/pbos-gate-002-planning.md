...
```json
{
  ...
  "selectedGate": "PBOS-GATE-002",
  "completedTasks": [
    "Selected PBOS-GATE-002 as the next eligible production-safe sprint.",
  ...
  "duration": 269,
  "timestamp": "2026-08-10T08:46:52.201Z",
  "release": {
    "currentState": "PROMOTION_COMPLETE",
    "previousState": "PROMOTION_PENDING",
    "transitionTimestamp": "2026-08-10T08:46:52.193Z",
...
## Recommendation
PBOS-GATE-002 has no configured next gate.
