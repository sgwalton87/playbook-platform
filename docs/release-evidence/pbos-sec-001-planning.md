...
```json
{
  ...
  "selectedGate": "PBOS-SEC-001",
  "completedTasks": [
    "Selected PBOS-SEC-001 as the next eligible production-safe sprint.",
  ...
  "duration": 265,
  "timestamp": "2026-08-10T08:37:13.127Z",
  "release": {
    "currentState": "PROMOTION_COMPLETE",
    "previousState": "PROMOTION_PENDING",
    "transitionTimestamp": "2026-08-10T08:37:13.120Z",
...
## Recommendation
PBOS-SEC-001 has no configured next gate.
