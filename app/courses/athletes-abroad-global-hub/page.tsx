...
import { ATHLETES_ABROAD_GLOBAL_HUB_COURSE } from "@/lib/courses/athletesAbroadGlobalHubCourse";

export default function AthletesAbroadGlobalHubCoursePage() {
  const course = ATHLETES_ABROAD_GLOBAL_HUB_COURSE;

  return (
    <main style={page}>
      <section style={hero}>
        <p style={eyebrow}>Athlete Abroad Course · {course.minutes} minutes · {course.points} points</p>
