    ...
    <main style={page}>
      ...
      <section style={hero}>
        <div style={heroCopy}>
          ...
          <p style={heroEyebrow}>Choose your Playbook</p>
      ...
      <section style={grid}>
        {roleOptions.map((option, index) => (
          <Link
            key={option.role}
            href={getOnboardingDestination(option.role)}
            style={roleCard}
          >
            ...
            <strong style={action}>Start {option.label} onboarding →</strong>
          </Link>
        ))}
      </section>
    </main>
...
const memberPrompt: React.CSSProperties = { color: "#475569", fontSize: 13, fontWeight: 700 };
const signInLink: React.CSSProperties = { color: "#0F172A", fontWeight: 900, textDecoration: "none" };
const navSignup: React.CSSProperties = { background: "#C2410C", color: "#FFFFFF", borderRadius: 999, padding: "10px 16px", fontWeight: 950, textDecoration: "none", boxShadow: "0 8px 20px rgba(194,65,12,.22)" };
...
const eyebrow: React.CSSProperties = { margin: "18px 0 8px", fontFamily: "'Space Mono', monospace", fontSize: 10, letterSpacing: ".18em", textTransform: "uppercase", fontWeight: 800, color: "#C2410C" };
const heroEyebrow: React.CSSProperties = { ...eyebrow, color: "#FB923C" };
...
const primaryAction: React.CSSProperties = { display: "inline-flex", alignItems: "center", justifyContent: "center", background: "#C2410C", color: "#FFFFFF", borderRadius: 999, padding: "12px 18px", fontSize: 14, fontWeight: 950, textDecoration: "none", boxShadow: "0 12px 28px rgba(194,65,12,.28)" };
...
const roleCard: React.CSSProperties = { minHeight: 270, position: "relative", textAlign: "left", textDecoration: "none", background: "#FFFFFF", color: "#0F172A", border: "1px solid #E2E8F0", borderRadius: 24, padding: 24, cursor: "pointer", boxShadow: "0 14px 36px rgba(15,23,42,.06)", display: "flex", flexDirection: "column", alignItems: "stretch" };
...
const action: React.CSSProperties = { marginTop: "auto", paddingTop: 24, color: "#C2410C", fontSize: 13 };
